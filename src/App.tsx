...
const HUB_QA: { id: string; q: string; a: string }[] = [
  ...
  { id: "levelup",       q: "I got pushed out of my job and need new skills I can actually trade inside the network — I always lose track.", a: "Done — a 90-day plan to build a skill the network needs, broken into weekly milestones. I'll check in and keep score. Day 1 of 90 starts now." },
