...
const HUB_QA: { id: string; q: string; a: string }[] = [
  ...
  { id: "levelup",       q: "I want to get back into a daily routine over the next 90 days but I always lose track.", a: "Done — a 90-day routine, broken into weekly milestones. I'll check in and keep score. Day 1 of 90 starts now." },
