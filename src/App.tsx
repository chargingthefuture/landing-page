...
const LOOK_MA_ITEMS: { q: string; solutions: string[] }[] = [
  ...
  { q: "Do people you don't know stare at you strangely/treat you bad for no reason?", solutions: ["GentlePulse", "Mood", "Hub"] },
  { q: "Are new people pushing hard for you to be their new friend/roommate/romantic partner?", solutions: ["GentlePulse", "Chyme"] },
  { q: "Do people seem to know things about you that you have never told them before?", solutions: ["GentlePulse", "Chyme"] },
  { q: "Do people you don't know constantly try to talk to you/befriend you while you are out in public?", solutions: ["GentlePulse", "Mood", "Chyme"] },
  ...
  { q: "Do people try to bait you into doing drugs? Buying a gun? Buying self-defense gear? Drinking? Committing illegal acts?", solutions: ["GentlePulse", "Mood", "Chyme"] },
  { q: "If you are a woman, do perverted guys you don't know or just met straight up ask you for sex?", solutions: ["GentlePulse", "Chyme"] },
  { q: "If you are sitting in your car minding your own business do idiots come and park right by/next to you and sit there too? Usually buried in their phone? Even if you are parked in an isolated area?", solutions: ["GentlePulse", "Mood", "Chyme"] },
  ...
  { q: "Do weirdos try to get you to say bad things about other people? Or force a conversation about sex, politics or celebrities as if they are recording you?", solutions: ["Mood", "Chyme"] },
  ...
  { q: "Do you notice strange flashes of light wherever you go? Or at home/work?", solutions: ["Foundation", "Chyme", "LightHouse"] },
  { q: "Does everyone around you seem to be keeping some sort of a secret?", solutions: ["Hub", "Directory", "Chyme"] },
  { q: "Do weirdos offer you rides/solicit you for prostitution when you are just trying to walk down the street? Even during the day?", solutions: ["TrustTransport", "Chyme"] },
  { q: "Do you get strange phone calls/texts from numbers you don't know a lot?", solutions: ["Chyme", "Trust"] },
  { q: "Do your pets seem to sense that something is off/someone you don't know is near?", solutions: ["LightHouse", "Foundation", "Chyme"] },
  { q: "Do people seem like they are only pretending to be your friend/partner?", solutions: ["Mood", "Directory", "Chyme"] },
  { q: "Do store/hotel clerks suddenly act strangely when you give your name/id?", solutions: ["Hub", "Trust"] },
  { q: "If you go to Walmart/Target do the theft detectors beep once quickly when you walk in?", solutions: ["SocketRelay", "Trust"] },
  ...
  { q: "Do people you've never introduced yourself to somehow already know your name?", solutions: ["Hub", "Chyme"] },
