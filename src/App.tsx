...
const FEATURES: {
  ...
  { id: "skillshunt",    name: "SkillsHunt",       emoji: "🎓", icon: Award,      color: "#FBBF24", bg: "#1C1504", desc: "Nominate survivors to build the Directory and grow the economy.", youtubeId: "OfojmleoDEc" },
